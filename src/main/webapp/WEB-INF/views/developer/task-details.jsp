            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <main class="col-md-9 ms-sm-auto col-lg-10 px-4 py-3">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end shadow border-0"
                                                ...
                                                <li><a class="dropdown-item fw-medium text-success"
                                                        href="${pageContext.request.contextPath}/developer/tasks/status/${task.taskId}?action=IN_PROGRESS"><i
                                                            class="bi bi-play-circle me-2"></i>Set to In Progress</a>
                                                </li>
                                                <li><a class="dropdown-item fw-medium text-primary"
                                                        href="${pageContext.request.contextPath}/developer/tasks/status/${task.taskId}?action=DONE"><i
                                                            class="bi bi-check-circle me-2"></i>Mark as Done</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            <a href="${pageContext.request.contextPath}/developer/tasks"
