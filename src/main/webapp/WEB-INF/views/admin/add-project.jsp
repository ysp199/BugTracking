                ...
                <div class="row">
                    ...
                    <main class="col-md-9 ms-sm-auto col-lg-10 px-4 py-3">
                        <jsp:include page="../common/topbar.jsp">
                            <jsp:param name="title" value="New Project" />
                        </jsp:include>
                        <div class="table-card mt-3 p-4" style="max-width: 600px;">
                            <form action="${pageContext.request.contextPath}/admin/projects/save" method="post">
                                ...
                                <div class="mb-3">
                                    <label class="form-label text-danger fw-bold">Assign to Project Manager</label>
                                    <select name="createdById" class="form-select" required>
                                        <option value="" disabled selected>Select a PM...</option>
                                        <c:forEach items="${pmUsers}" var="pm">
                                            <option value="${pm.userId}" ${project.createdBy !=null &&
                                                project.createdBy.userId==pm.userId ? 'selected' : '' }>${pm.firstName}
                                                ${pm.lastName} (${pm.email})</option>
                                        </c:forEach>
                                    </select>
                                </div>
                                <div class="row">
